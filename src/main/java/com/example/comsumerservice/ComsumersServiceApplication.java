...
public class ComsumersServiceApplication {

    public static void main(String[] args) {
        SpringApplication.run(ComsumersServiceApplication.class, args);
    }
...
//				@SendTo(PAGE_COUNTS_OUT)
				public void process(@Input(PAGE_VIEW_IN) KStream<String, User> events) {

					events.filter((s, user)-> user.getName().startsWith("j")).foreach((s,user)->log.info("Usernamwe:-"+user));
				}
		}
